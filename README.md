...
运行基线保持 Node 20.19.5、Prisma 6.19.3 与 `undici@7.28.0`。PostgreSQL 匿名工作区、Context Plan、Rolling Summary、Streaming / Revision Safety、企业知识包和持久化导入任务继续保持原有语义；没有新增 migration。本版本不保存原始上传文件，不接入对象存储，不支持 OCR；腾讯云仍运行 V2.0.4，本次 Git 发布不执行云端部署。
