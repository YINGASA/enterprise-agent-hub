...
export function routeUserQuestion(question: string): AgentRoute {
  ...
  const engineeringKeywords = ["Real API", "\u90e8\u7f72\u68c0\u67e5", "sourceType", "scoreReason", "Top sources", "\u7528\u6237\u6587\u6863", "\u9ed8\u8ba4\u77e5\u8bc6\u5e93", "\u6765\u6e90", "Prompt", "\u63d0\u793a\u8bcd", "RAG", "\u68c0\u7d22\u8d28\u91cf", "Agent", "\u5de5\u5177\u8c03\u7528", "\u7ed3\u6784\u5316\u8f93\u51fa", "JSON", "fallback", "API Key", "\u8bc4\u6d4b\u96c6", "\u53ef\u89c2\u6d4b\u6027", "\u65e5\u5fd7", "Schema", "\u6a21\u578b\u8fd4\u56de"];
...
function inferRagPackId(question: string, route: AgentRoute) {
  if (hasAny(question, ["Prompt", "\u63d0\u793a\u8bcd", "RAG", "\u68c0\u7d22\u8d28\u91cf", "Agent", "\u5de5\u5177\u8c03\u7528", "\u7ed3\u6784\u5316\u8f93\u51fa", "JSON", "fallback", "API Key", "\u8bc4\u6d4b\u96c6", "\u53ef\u89c2\u6d4b\u6027", "\u65e5\u5fd7", "Schema", "\u6a21\u578b\u8fd4\u56de", "sourceType", "scoreReason", "Top sources", "\u7528\u6237\u6587\u6863", "\u9ed8\u8ba4\u77e5\u8bc6\u5e93", "\u6765\u6e90", "Real API"])) return "ai-engineering" as const;
